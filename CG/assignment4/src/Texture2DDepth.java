...
public class Texture2DDepth extends Texture2D{

  public Texture2DDepth(int width, int height){
    super(width,height);
  }

  public Texture2DDepth(TextureImage img){
    super(img);
  }
  ...
  public void init(GL2GL3 gl){
    ...
    */
    ...
    gl.glTexImage2D(GL2.GL_TEXTURE_2D, 0, GL2.GL_DEPTH_COMPONENT, WIDTH, HEIGHT,
                    0, GL2.GL_DEPTH_COMPONENT, GL.GL_HALF_FLOAT, buffer);
